...
void					ft_lstiter_lem(t_list *lst, void *param, t_lemin *lem,
							void (*f) (t_list *, void *, t_lemin *));
void					ft_lstiter12(t_list *lst, void *param,
							void (*f)(t_list *, void *));
int						ft_lstlen(t_list *head);
t_list					*ft_sort_lst(t_list *lst, int (*cmp)
							(t_list *, t_list *));
...
void					lst2d_step(t_list_2d **head,
							t_list_2d **prior, t_list_2d *new);
t_list					*ft_lstnew_link(void *content, size_t content_size);
...
void					resolve(t_list **curr, t_list *all_paths,
							t_lemin *lem);
...
void					pars_start_to_end(char *sigh, t_ways *ways,
							t_lemin *lem);
...
void					ft_lstiter4(t_lemin *lem, t_lemin *param1,
							t_lemin *param2,
							void (*f)(t_lemin *, t_lemin *, t_lemin *));
...
t_list					*sort_list(t_list *lst, int (*cmp_ways)
							(t_list *, t_list *));
int						croissant(t_list *way1, t_list *way2);
void					first_move(t_lemin *lem, t_ant *ant,
							int sum_paths, int *len_of_path);
void					first_move_super(t_lemin *lem, t_ant *ant,
							int sum_paths, int *len_of_path);
void					print_move(t_lemin *lem, t_ant *ant, char c);
void					move_along(t_lemin *lem, t_ant *ant,
							int *len_of_path, t_ways *ways);
void					move_along_super(t_lemin *lem, t_ant *ant,
							int *len_of_path);
int						norm_way(t_lemin *lem, int y, int *len_of_path);
void					try_first_move(t_lemin *lem, t_ant **ant,
							int *moved, int *y);
void					lst2d_stepmodif(t_list_2d **head,
							t_list_2d **prior, t_list_2d *new);
char					*get_room(t_lemin *lem, int y, int x);
void					print_ants(t_lemin *lem, t_ways *ways,
							int sum_paths, int *len_of_path);
t_list					*ft_lstcopy(t_list *lst);
void					middle_al_bfc();
void					ft_lstiter2_my(t_list *lst, t_lemin *lem, void *param,
							void (*f)(t_lemin *, t_list *, void *));
void					ft_lstiter2(t_list *lst, void *param,
							void (*f)(t_list *, void *));
void					start_bfc(t_lemin *start, t_lemin *end,
							t_lemin *lem, t_ways *ways);
void					start_b(t_lemin *start, t_lemin *end,
							t_lemin *lem, t_ways *ways);
